...
async function requirement3(jsondata, filename) {
    ...
    if(validation3array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Voucher Number', paymentid: '' };
    }
    for (var i = 0; i < jsondata.length; i++) {
...
async function requirement4(jsondata, filename) {
    ...
    if(validation4array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Payment Amount', paymentid: '' };
    }
    var amt101;
    var billarray = [];
    var amountarray = [];
...
async function requirement5(jsondata, filename) {
    ...
    if(validation5array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Bill not Approved', paymentid: '' };
    }
...
async function requirement6(jsondata, filename) {
    ...
    if(validation6array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Beneficiary Account', paymentid: '' };
    }
    for (var ab = 0; ab < jsondata.length; ab++) {
...
async function requirement7(jsondata, filename) {
    ...
    // if(validation7array.length == 0){
    //     return { validationresult: false, failurereason: 'No data in DB : Sanction Order', paymentid: '' };
    // }
    for (var ab = 0; ab < jsondata.length; ab++) {
...
async function requirement8(jsondata, filename) {
    ...
    if(validation8array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Voucher Date', paymentid: '' };
    }
    // var count9 =0;
    var ab = 0;
...
async function requirement9(jsondata, filename) {
    ...
    if(validation9array.length == 0){
        return { validationresult: false, failurereason: 'No data in DB : Treasury Account', paymentid: '' };
    }
    for (var ab = 0; ab < jsondata.length; ab++) {
